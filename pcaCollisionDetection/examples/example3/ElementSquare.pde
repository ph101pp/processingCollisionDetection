class ElementSquare extends MyCollisionElement{
////////////////////////////////////////////////////////////////////////////////
	example2	that;
	Color		elementColor;
	boolean		mouseColor;
////////////////////////////////////////////////////////////////////////////////
	public ElementSquare(example2 that_){	
		that=that_;
...
////////////////////////////////////////////////////////////////////////////////
	public void collide(ElementMouse element, CollisionMap collisionMap, boolean mainCollision) {
...
////////////////////////////////////////////////////////////////////////////////
	void draw() {
		...
		rect(location.x,location.y, actionRadius*2,actionRadius*2);
