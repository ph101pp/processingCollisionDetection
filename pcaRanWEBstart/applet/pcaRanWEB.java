...
public class pcaRanWEBstart extends PApplet {
...
//	PROGRAMM
	PVector newLocation;
///////////////////////////////////////////////////////////
	ElementBlob(pcaRanWEBstart that_, PVector location_, float actionRadius_) {
		that=that_;
	...
	ElementBlob(pcaRanWEBstart that_, PVector location_) {
		that=that_;
...
class ElementChaos extends MyCollisionElement {
	...
	///////////////////////////////////////////////////////////
	ElementChaos(pcaRanWEBstart that_, float actionRadius_) {
		that=that_;
		actionRadius=actionRadius_;
		location = new PVector (random(width), random(height),random(that.depth));
	}
	ElementChaos(pcaRanWEBstart that_) {
		that=that_;
		actionRadius=defaultRadius;
		location = new PVector (random(width), random(height),random(that.depth));
	}
...
///////////////////////////////////////////////////////////
	ElementLorenz(pcaRanWEBstart that_, PVector location_, ElementBlob blob_, float actionRadius_) {
		that=that_;
		blob=blob_;
		actionRadius=actionRadius_;
		location = location_;
...
/////////////////////////////////////////////////////////
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "pcaRanWEBstart" });
  }
}
